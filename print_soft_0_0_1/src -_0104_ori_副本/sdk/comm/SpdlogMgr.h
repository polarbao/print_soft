...
// 日志宏 - 支持流式输出
#define LOG_T(...)	SpdlogWrapper::GetInstance()->GetLogger()->trace(msg)
#define LOG_D(...)	SpdlogWrapper::GetInstance()->GetLogger()->debug(msg)
#define LOG_I(...)	SpdlogWrapper::GetInstance()->GetLogger()->info(msg)
#define LOG_W(...)	SpdlogWrapper::GetInstance()->GetLogger()->warn(msg)
#define LOG_E(...)	SpdlogWrapper::GetInstance()->GetLogger()->error(msg)
#define LOG_C(...)	SpdlogWrapper::GetInstance()->GetLogger()->critical(msg)


// 命名日志器宏
#define NAMED_LOG_T(name, msg)  SpdlogWrapper::GetInstance()->GetLogger(name)->trace(msg)
#define NAMED_LOG_D(name, msg)  SpdlogWrapper::GetInstance()->GetLogger(name)->debug(msg)
#define NAMED_LOG_I(name, msg)  SpdlogWrapper::GetInstance()->GetLogger(name)->info(msg)
#define NAMED_LOG_W(name, msg)  SpdlogWrapper::GetInstance()->GetLogger(name)->warn(msg)
#define NAMED_LOG_E(name, msg)  SpdlogWrapper::GetInstance()->GetLogger(name)->error(msg)